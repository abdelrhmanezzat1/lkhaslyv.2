  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: requestsAsync.when(
        data: (requests) {
          if (requests.isEmpty) {
            return _PremiumEmptyState(
              ...
              message: 'New service requests will appear here in real-time.',
              actionLabel: 'Refresh',
              onAction: () => ref.invalidate(requestsControllerProvider),
            );
          }

          return RefreshIndicator(
            onRefresh: () async => ref.invalidate(requestsControllerProvider),
        ...
        loading: () =>
            const Center(child: AppLoader(message: 'Loading requests...')),
        error: (error, stack) => _PremiumErrorState(
          message: 'Failed to load requests: $error',
          onRetry: () => ref.invalidate(requestsControllerProvider),
        ),
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: AppCard(
          ...
          child: Column(
            ...
            children: [
              // Header with service type badge and time
              Row(
                children: [
                  Container(
